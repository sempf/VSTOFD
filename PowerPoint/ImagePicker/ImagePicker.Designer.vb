...
Partial Public NotInheritable Class ImagePicker
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _ImagePicker As ImagePicker

    Private Shared _ThisRibbonCollection As ThisRibbonCollection

    Friend Shared Property ImagePicker() As ImagePicker
        Get
            Return _ImagePicker
        End Get
        Set(ByVal value As ImagePicker)
            If (_ImagePicker Is Nothing) Then
                _ImagePicker = value
            Else
